    ...
    <div className="fixed inset-0 z-[100] bg-background flex flex-col">
      ...
      <div className="px-4 pt-5 pb-3 flex items-center gap-3 shrink-0">
        ...
        <div className="flex-1 text-center">
          <h1 className="text-base font-bold text-foreground">{song.title}</h1>
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-8">
            ...
            >
              {song.lyrics.length === 0 && (
                <p className="text-base text-muted-foreground text-center">暂无歌词</p>
              )}
                  ...
                  >
                    <p
                      className={`font-bold transition-all duration-300 ${
                        isCurrent
                          ? 'text-foreground text-2xl drop-shadow-lg'
                          : isPast
        ...
        <div className="px-4 py-2 shrink-0">
          <div className="bg-secondary rounded-xl p-2">
            <div className="flex items-center gap-2 overflow-x-auto">
              ...
              <button
                onClick={clearTakes}
                className="px-2 py-1.5 rounded-lg text-xs text-muted-foreground hover:text-foreground hover:bg-secondary/80 transition-colors shrink-0"
              >
      ...
      <div className="px-6 pb-6 pt-3 shrink-0 flex flex-col items-center">
        ...
        {showVolume && (
          <div className="fixed left-1/2 -translate-x-1/2 bottom-28 z-50 w-[90%] max-w-sm bg-card rounded-2xl p-3 space-y-2 shadow-2xl border border-border/50">
            <div className="flex items-center gap-3">
              <button
                onClick={() => setAiEnabled(!aiEnabled)}
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                  aiEnabled ? 'bg-primary/30 text-primary' : 'bg-secondary text-muted-foreground'
                }`}
              >
            ...
            <div className="flex items-center gap-3">
              <span className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-secondary text-muted-foreground">
        ...
        <div className="flex items-center justify-center gap-5">
          ...
          <button
            ...
            className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${
              recording
                ? 'bg-destructive text-destructive-foreground scale-110 animate-pulse shadow-lg shadow-destructive/30'
                : 'bg-secondary text-muted-foreground hover:bg-secondary/80'
            }`}
          >
